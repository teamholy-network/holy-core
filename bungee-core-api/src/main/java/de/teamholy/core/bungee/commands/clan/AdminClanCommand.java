        ...
        BungeeCore.getAPI().getExecutor().execute(() -> {
            if (args.length == 1) {
                ...
                if (args[0].equalsIgnoreCase("delete")) {
                    ...
                    if (clan == null) {
                        sender.sendMessage(Message.CLAN_PREFIX + "§c"+BungeeUtil.format("The clan {} doesn't exists!", tag));
                        return;
                    }
                    ...
                    sender.sendMessage(Message.CLAN_PREFIX + "§a"+BungeeUtil.format("You deleted the clan {}!", clan.getTag()));
                } else if (args[0].equalsIgnoreCase("kick")) {
                    ...
                    if (clanPlayerProfile == null) {
                        sender.sendMessage(Message.CLAN_PREFIX + "§c"+BungeeUtil.format("The player {} doesn't has a clan!", target));
                        return;
                    }
                    ...
                    sender.sendMessage(Message.CLAN_PREFIX + "§a"+BungeeUtil.format("The player §c{}§a got kicked from §e{}§a!", target, clan.getTag()));
                    ...
                    BungeeCore.getInstance().getBungeePlayerManager().sendClanMessage(clan, Message.CLAN_PREFIX + "§7"+"The player"+" " +
                        ...
                        "§7 "+BungeeUtil.format("was promoted to {}", promote.getFancy()) + "§7!");
                } else {
                    printUsage(sender);
                }
