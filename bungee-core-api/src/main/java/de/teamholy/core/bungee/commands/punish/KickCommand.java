...
public class KickCommand extends SenderCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        target.disconnect("§c" + BungeeUtil.format("You have been kicked from the {} network!", "TeamHoly.DE") + " \n§7" + "Reason" + " §8» §e" + reason);
        ...
        for (ProxiedPlayer staffNotifyPlayer : BungeeCore.getInstance().getBungeePlayerManager().getStaffNotifyPlayers()) {
            staffNotifyPlayer.sendMessage(prefix + BungeeUtil.format("{} got kicked by {} for {}", kicked + "§7", name + "§7", "§c" + reason + "§7"));
        }
    }
}
