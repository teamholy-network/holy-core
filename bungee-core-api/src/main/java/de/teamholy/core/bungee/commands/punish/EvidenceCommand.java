    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (args.length == 3) {
            ...
            if (isBan) {
                ...
                sender.sendMessage(Message.PUNISH_PREFIX + "§7" + ("You changed the ban-evidence of §e" + (target) + "§7!"));
                ...
                sender.sendMessage(Message.PUNISH_PREFIX + "§7" + ("You changed the mute-evidence of §e" + (target) + "§7!"));
