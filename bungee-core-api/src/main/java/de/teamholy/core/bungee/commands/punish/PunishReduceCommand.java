        ...
        if (args.length == 3) {
            ...
            try {
                ...
                if (isBan) {
                    ...
                    sender.sendMessage(Message.PUNISH_PREFIX + "§7" + BungeeUtil.format("You changed the ban-time of §e{}§7 to §c{}§7!", target, timeLeft));
                    ...
                    sender.sendMessage(Message.PUNISH_PREFIX + "§7" + BungeeUtil.format("You changed the mute-time of §e{}§7 to §c{}§7!", target, timeLeft));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
