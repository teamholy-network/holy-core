...
public class LinkManager {
    ...
    public void relinkPlayer(ProxiedPlayer player) {
        ...
        if (System.currentTimeMillis() - statsProfile.getPlayerProfileLastTimeLinked() < 60 * 60 * 1000) {
            player.sendMessage("§6Web §8× §7" + ("Please wait around " + ("§e" + helpers.getRemainingTime(statsProfile.getPlayerProfileLastTimeLinked(), 60 * 60 * 1000) + "§7") + " minutes before you can relink your account!"));
            return;
        }
