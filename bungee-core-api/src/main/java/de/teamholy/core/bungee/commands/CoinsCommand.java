            ...
            switch (args[0].toLowerCase()) {
                case "add" -> {
                    ...
                    if (receiver != null) {
                        ...
                        receiver.sendMessage(prefix + ("You received §6" + (String.valueOf(coinsArg)) + " Coins§7!"));
                        receiver.sendMessage(" ");
                    }

                    sender.sendMessage(prefix + ("You added §6" + (String.valueOf(coinsArg)) + " Coins§7 to " + (BungeeCore.getInstance().getPlayerColor(uuid) + args[1])));
                }
                case "set" -> {
                    ...
                    if (receiver != null) {
                        receiver.sendMessage(" ");
                        receiver.sendMessage(prefix + ("Your Coins have been set to §6" + (String.valueOf(coinsArg)) + " Coins§7!"));
                        receiver.sendMessage(" ");
                    }

                    sender.sendMessage(prefix + ("You set " + (BungeeCore.getInstance().getPlayerColor(uuid) + args[1]) + " Coins to §6" + (String.valueOf(coinsArg))));
                }
                case "remove" -> {
                    ...
                    sender.sendMessage(prefix + ("You removed §6" + (String.valueOf(coinsArg)) + " Coins§7 from " + (BungeeCore.getInstance().getPlayerColor(uuid) + args[1]) + "§7's account!"));
                }
            }
