...
public enum PlayerRank {
    ...
    MANAGER("Manager","§4Manager §8┃ §4", "§4Manager §8┃ §4","§4",7200,
            153,0,0),
    YTPLUS("YoutuberPlus","§4Youtuber+ §8┃ §4",  "§4YT+ §8┃ §4","§4",7300,
            153,0,0),
    ...
    BUILDER("Builder","§eBuilder §8┃ §e", "§eBuild §8┃ §e","§e",8100,
            255, 255, 0),
    DESIGNER("Designer","§9Designer §8┃ §9", "§9Des §8┃ §9","§9",8200,
            0, 102, 255),
    ...
    VIP("VIP","§dVIP §8┃ §d", "§dVIP §8┃ §d","§d",8500,
            204, 0, 153),
    PREMIUMPLUS("PremiumPlus","§ePremium+ §8┃ §e", "§eP+ §8┃ §e","§e",8600,
            255, 255, 0),
    PREMIUM("Premium","§6Premium §8┃ §6", "§6P §8┃ §6","§6",8700,
            204, 102, 0),
