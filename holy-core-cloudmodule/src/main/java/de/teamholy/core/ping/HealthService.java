...
public class HealthService {
    ...
    public void stopService(String name) {
        ...
        for (var serverInfo : serviceInfoSnapshots) {
            if (serverInfo.getServiceId().getName().toLowerCase().contains("lobby") || serverInfo.getServiceId().getName().toLowerCase().contains("clutches") && serverInfo.getServiceId().getName().equalsIgnoreCase(name)) {
